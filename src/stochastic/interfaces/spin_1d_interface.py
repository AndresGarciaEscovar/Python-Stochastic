...
# User.
from stochastic.utilities.spin_1d_parameters import Spin1DParameters
...
class Spin1D(metaclass=ABCMeta):
    ...
    def length(self, length: int) -> None:
        """
            ...
            :param length: The length of the lattice. A positive integer
             number.
        """
    ...
    def repetitions(self, repetitions: int) -> None:
        """
            ...
            :param repetitions: The number of times that the simulation must be
             averaged to get statistically significant results. If the number
             is negative, the absolute value will be taken.
        """
    ...
    def get_empty_nts(self, order: int):
        ...
        for site in range(self.length):
            empty = self.lattice[site] == Spin1D.UP
            ...
            for site_ in range(1, order):
                ...
                empty = empty and self.lattice[site_] == Spin1D.DOWN
    ...
    def save_lattice(self, initial: bool = True, last: bool = False) -> None:
        """
    ...
    def statistics_record(self, number_simulations: int = None) -> None:
        """
            ...
            :param number_simulations: The number of simulation with which to
             take the average.
        """
        ...
        successful = singlets + doublets + triplets
        ...
        self.statistics_table.append([
            elapsed_time, successful, singlets, doublets, triplets
        ])
    ...
    def __init__(self, parameters: Spin1DParameters):
        ...
        # Counters.
        self.attempts = 0
        self.spins_down = -int(parameters.length)
