...
are irreversibly, and randomly, deposited onto a substrate. Once particles are deposited, they
cannot be removed or rearranged.  As particles are added, the subtrate becomes
populated, and eventually saturates, reaching a state where no more particles
can be added.
